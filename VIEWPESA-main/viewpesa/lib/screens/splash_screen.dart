...
class _SplashScreenState extends State<SplashScreen>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: const Color(0xFF1A412C), // Safaricom dark green
      body: Center(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                ...
                style: TextStyle(color: Colors.greenAccent.shade100, fontSize: 14),
              ),
              const SizedBox(height: 20),
              SizedBox(
                width: 200,
                child: ClipRRect(
                  ...
                  child: LinearProgressIndicator(
                    ...
                    valueColor: const AlwaysStoppedAnimation<Color>(
                      Color(0xFFE30613), // Safaricom red accent
                    ),
                    minHeight: 8,
                  ),
                ),
